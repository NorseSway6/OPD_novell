...
define config.name = _("Название новеллы")
...
define gui.about = _p("""Игра (название игры) поможет абитуриентам узнать больше о                       такой профессии как тестировщик компьютерных игр.
