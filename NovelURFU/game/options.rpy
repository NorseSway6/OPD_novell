...
define config.name = _("Путь в неизвестность")
...
define gui.about = _p("""Игра "Путь в неизвестность" поможет абитуриентам узнать больше о                       такой профессии как тестировщик компьютерных игр.

Ваша команда Backside""")
...
define config.save_directory = "NovelURFU-1726940754"
