...
label history:
    ...
    show team at secondary_character
    ...
    n "С полученными данными Олег идет к Дмитрию, чтобы сообщить о дальнейших действиях."
    show oleg at come_skin
    show dima at secondary_character
    o "Дмитрий, у нас уже есть данные по разрушениям. Ситуация сложная, но сидеть сложа руки мы не можем. Нужно начать восстановление города, и начинать надо с приоритетных направлений."
    d "Согласен, Олег. Какие направления считаешь первоочередными?"
    ...
    d "Полностью поддерживаю. Без водоснабжения  и здравоохранения начнется эпидемия, санитарные условия уже на грани. Без электричества невозможно наладить стабильную работу больниц, системы очистки воды, не говоря уже о бытовых нуждах людей."
    ...
    d "Нужно срочно разработать хотя бы несколько полевых медицинских пунктов. Половина больниц разрушена или не функционирует. У людей ни лекарств, ни места для лечения. Я займусь составлением проекта по их восстановлению. Начнем с оценки ресурсов."
    o "Отлично, начинаем. Теперь важно не терять времени."
    d "Понял. За дело!"
    hide oleg
    hide dima

    n "Первым шагом становится восстановление системы управления городом. Эта система позволяет оптимизировать работу всех городских служб, таких как транспорт, водоснабжение, электроснабжение и здравоохранение. Она также помогает отслеживать состояние зданий и инфраструктуры, что позволяет быстро выявлять и устранять проблемы. Над этой задачей трудятся Дмитрий и его последователи разработчики."
    n "После выявления всех проблем Данил и его помощники начинают разрабатывать проекты районов города и восстанавливать систему водоснабжения, электроснабжения и жилые здания. Количество жилых зданий быстро начинает расти и вскоре доходит до первоначальных значений. Они также используют современные технологии строительства. Кроме того, благодаря команде Дмитрия они внедряют в городе систему «умного дома», которая позволяет жителям управлять своими домами с помощью мобильных устройств. Но все равно остается чувство незавершенности, все это из-за того, что здания выглядят мрачными и скучными, что сказывается на моральной составляющей жителей."
    ...
    hide skin
    hide king
    n "King идет в правительство вместе с [name]. King показывают на всех экранах города, где он дает свою речь."
    show king at center
    ...
    n "После тяжелого и напряженного дня Максим идет к себе домой и ложится спать."
    scene teenager room
    with fade
    n "А просыпается Максим от того, что ему в глаза светит солнце на часах уже полдень и понимает, что уснул, когда играл в Town Simulator, и все, что с ним произошло, всего лишь сон, но он прекрасно помнит, что происходило этой ночью в его голове. И он, наконец-то, определился с будущей профессией. Садиться и дальше продолжает готовиться к ЕГЭ..."
    nvl hide
