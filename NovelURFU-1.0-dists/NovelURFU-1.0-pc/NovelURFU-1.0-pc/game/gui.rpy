...
define gui.accent_color = '#fafafa'

## Цвет, используемый в текстовой кнопке, когда она не выбрана и не наведена.
define gui.idle_color = '#fafafa'
...
define gui.muted_color = '#858585'
define gui.hover_muted_color = '#fafafa'

## Цвета, используемые в тексте диалогов и выборов.
define gui.text_color = '#fafafa'
define gui.interface_text_color = '#fafafa'
...
define gui.main_menu_background = "gui/background_main_menu.jpg"
...
define gui.choice_button_width = 1050
...
## Местоположение, ширина и выравнивание диалогового текста.
define gui.nvl_text_xpos = 650
define gui.nvl_text_ypos = 230
define gui.nvl_text_width = 1116
